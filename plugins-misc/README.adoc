...
|`dev.daymor.ultimanexus.jvm.gradle.bundle.ultima-nexus-jvm`
...
ultimanexus-bundle-ultima-nexus-jvm = { id = "dev.daymor.ultimanexus.jvm.gradle.bundle.ultima-nexus-jvm", version.ref = "ultima-nexus-plugins" }
