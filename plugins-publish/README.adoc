...
ultimanexus-feature-publish-maven-central-aggregation = { id = "dev.daymor.ultimanexus.jvm.gradle.feature.publish-maven-central-aggregation", version.ref = "ultima-nexus-plugins" }
----
