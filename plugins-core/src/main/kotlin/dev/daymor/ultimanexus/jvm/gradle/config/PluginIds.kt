...
object PluginIds {
    ...
    object Bundle {
        ...
        const val JAVA_SIMPLE = "$PREFIX.bundle.java-simple"
        const val JAVA_COMPLETE = "$PREFIX.bundle.java-complete"
        const val JVM_COMPLETE = "$PREFIX.bundle.jvm-complete"
        const val SPRING_BOOT_SIMPLE = "$PREFIX.bundle.spring-boot-simple"
        const val SPRING_BOOT_COMPLETE = "$PREFIX.bundle.spring-boot-complete"
    ...
    object Feature {
        ...
        const val JAVA_UNIFIED = "$PREFIX.feature.java-unified"
        const val JAVADOC = "$PREFIX.feature.javadoc"
        const val SPRING_BOOT_UNIFIED = "$PREFIX.feature.spring-boot-unified"
