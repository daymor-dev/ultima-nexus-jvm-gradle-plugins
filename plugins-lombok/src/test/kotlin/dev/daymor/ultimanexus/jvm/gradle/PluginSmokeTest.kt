...
class PluginSmokeTest {
    ...
    @Nested
    inner class LombokPlugin {

        @Test
        fun `lombok plugin applies successfully`() {
            fixture()
                ...
                .withBuildScript(
                    ...
                    plugins {
                        java
                        id("${PluginIds.Dependency.LOMBOK}")
                    }
                    """.trimIndent()
                )
    ...
    @Nested
    inner class LombokTestPlugin {

        @Test
        fun `lombok-test plugin applies successfully`() {
            fixture()
                .withSettings("rootProject.name = \"test-project\"")
                .withBuildScript(
                    """
                    plugins {
                        java
                        id("${PluginIds.Dependency.LOMBOK_TEST}")
                    }
                    """.trimIndent()
                )
    ...
    @Nested
    inner class LombokBundle {

        @Test
        fun `lombok bundle applies successfully`() {
            fixture()
                .withSettings("rootProject.name = \"test-project\"")
                .withBuildScript(
                    """
