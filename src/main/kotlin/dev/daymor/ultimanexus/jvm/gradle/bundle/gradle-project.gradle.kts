...
/**
 * Bundle plugin for base Gradle project conventions.
 * Applies lifecycle tasks, project identity, dependency rules,
 * Gradle file formatting, version catalog enforcement, and Maven Central repository.
 *
 * Usage:
 * plugins {
...
plugins {
    ...
    id("dev.daymor.ultimanexus.jvm.gradle.feature.repositories")
}
