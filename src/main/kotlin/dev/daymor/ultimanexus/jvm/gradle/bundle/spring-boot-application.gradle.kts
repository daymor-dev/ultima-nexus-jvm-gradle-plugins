...
/**
 * Bundle plugin for Spring Boot application development.
 * Includes quality checks, testing, and Spring Boot application setup.
 *
 * Usage:
 * plugins {
 *     id("dev.daymor.ultimanexus.jvm.gradle.bundle.spring-boot-application")
 * }
 */
plugins {
    ...
    id("dev.daymor.ultimanexus.jvm.gradle.dependency.spring-boot-application")
