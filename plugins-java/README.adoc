...
|JSpecify nullability annotations (main sources only)

|`dev.daymor.ultimanexus.jvm.gradle.dependency.jspecify-test`
|JSpecify nullability annotations (test sources only)

|`dev.daymor.ultimanexus.jvm.gradle.bundle.jspecify`
|JSpecify nullability annotations for main and test sources
...
[plugins]
ultimanexus-jvm-bundle-java-simple-application = { id = "dev.daymor.ultimanexus.jvm.gradle.bundle.java-simple-application", version.ref = "ultima-nexus-plugins" }
ultimanexus-jvm-bundle-java-simple-library = { id = "dev.daymor.ultimanexus.jvm.gradle.bundle.java-simple-library", version.ref = "ultima-nexus-plugins" }
ultimanexus-jvm-bundle-java-complete-application = { id = "dev.daymor.ultimanexus.jvm.gradle.bundle.java-complete-application", version.ref = "ultima-nexus-plugins" }
...
ultimanexus-jvm-feature-compile-java = { id = "dev.daymor.ultimanexus.jvm.gradle.feature.compile-java", version.ref = "ultima-nexus-plugins" }
----
...
Adds JSpecify as `compileOnly` for main sources only:
...
Adds JSpecify as `testCompileOnly` for test sources only:
