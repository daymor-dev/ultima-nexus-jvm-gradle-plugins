...
/*
 * Plugin: dev.daymor.ultimanexus.jvm.gradle.bundle.java-simple-library
 *
 * Bundle plugin for simple Java library development.
 * Includes base project conventions, Java compilation, and java-library plugin.
 * Does not include quality checks, tests, or publishing.
 *
 * For shared libraries, SDKs, or any reusable Java modules.
 *
 * Usage:
 * ```kotlin
 * plugins {
 *     alias(libs.plugins.ultimanexus.bundle.java.simple.library)
 * }
 * ```
 */
plugins {
