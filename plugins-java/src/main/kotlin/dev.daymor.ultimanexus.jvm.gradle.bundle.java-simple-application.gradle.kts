 ...
 * Includes base project conventions, Java compilation, and application plugin.
 * Does not include quality checks, tests, or publishing.
 *
 * For CLI tools, services, or any runnable Java application.
 *
 * Usage:
 * ```kotlin
 * plugins {
 *     alias(libs.plugins.ultimanexus.bundle.java.simple.application)
 * }
 * ```
 */
plugins {
