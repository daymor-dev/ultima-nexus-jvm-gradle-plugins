...
/**
 * Plugin: dev.daymor.ultimanexus.jvm.gradle.bundle.spring-boot-native-application
 *
 * Bundle plugin for simple Spring Boot native application development.
 ...
 *
 * Includes:
 * - Spring Boot application support (bootJar, bootRun)
 ...
 */
plugins {
    id("dev.daymor.ultimanexus.jvm.gradle.bundle.spring-boot-simple-application")
