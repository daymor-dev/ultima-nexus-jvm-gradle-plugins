...
|Spring Boot AOT compilation support with quality check exclusions

|`dev.daymor.ultimanexus.jvm.gradle.bundle.spring-boot-native-application`
|Simple Spring Boot application with GraalVM Native Image

|`dev.daymor.ultimanexus.jvm.gradle.bundle.spring-boot-native-complete-application`
|Complete Spring Boot application with GraalVM Native Image and quality checks
|===
...
[plugins]
ultimanexus-jvm-bundle-spring-boot-simple-application = { id = "dev.daymor.ultimanexus.jvm.gradle.bundle.spring-boot-simple-application", version.ref = "ultima-nexus-plugins" }
ultimanexus-jvm-bundle-spring-boot-simple-library = { id = "dev.daymor.ultimanexus.jvm.gradle.bundle.spring-boot-simple-library", version.ref = "ultima-nexus-plugins" }
ultimanexus-jvm-bundle-spring-boot-complete-application = { id = "dev.daymor.ultimanexus.jvm.gradle.bundle.spring-boot-complete-application", version.ref = "ultima-nexus-plugins" }
ultimanexus-jvm-bundle-spring-boot-complete-library = { id = "dev.daymor.ultimanexus.jvm.gradle.bundle.spring-boot-complete-library", version.ref = "ultima-nexus-plugins" }
ultimanexus-jvm-feature-spring-boot-application = { id = "dev.daymor.ultimanexus.jvm.gradle.feature.spring-boot-application", version.ref = "ultima-nexus-plugins" }
ultimanexus-jvm-feature-spring-boot-library = { id = "dev.daymor.ultimanexus.jvm.gradle.feature.spring-boot-library", version.ref = "ultima-nexus-plugins" }
ultimanexus-jvm-dependency-spring-boot-test = { id = "dev.daymor.ultimanexus.jvm.gradle.dependency.spring-boot-test", version.ref = "ultima-nexus-plugins" }
ultimanexus-jvm-bundle-spring-boot-native-application = { id = "dev.daymor.ultimanexus.jvm.gradle.bundle.spring-boot-native-application", version.ref = "ultima-nexus-plugins" }
ultimanexus-jvm-bundle-spring-boot-native-complete-application = { id = "dev.daymor.ultimanexus.jvm.gradle.bundle.spring-boot-native-complete-application", version.ref = "ultima-nexus-plugins" }
ultimanexus-jvm-feature-spring-boot-aot = { id = "dev.daymor.ultimanexus.jvm.gradle.feature.spring-boot-aot", version.ref = "ultima-nexus-plugins" }
----
...
* JSpecify nullability annotations (main and test sources)
...
== Spring Boot Native Bundles

Spring Boot application bundles with GraalVM Native Image and AOT support.

=== Spring Boot Native Complete Application

For standalone Spring Boot applications compiled to native executables:
...
* AOT source sets excluded from quality checks (Checkstyle, PMD, SpotBugs)
* AOT compiler warnings suppressed (`-Xlint:-unchecked`, `-Xlint:-rawtypes`)

=== Spring Boot Native Simple Application

For minimal Spring Boot native applications without quality checks:
...
Configures Spring Boot AOT compilation and excludes AOT-generated code from quality checks.

=== Usage

Applied automatically by native bundles. Can be applied independently:
...
NOTE: The AOT compile tasks (`compileAotJava`, `compileAotTestJava`) are exempt from `-Werror` by the link:../plugins-java/README.adoc[compile-java] plugin — Spring AOT-generated sources are machine-written and read a wide dependency surface that javac flags with mandatory classfile diagnostics.
...
* Adds Spring Boot Docker Compose support
...
NOTE: GraalVM Native Image properties (`graalvmNative.*`) are documented in the link:../plugins-native/README.adoc[plugins-native] module.
...
* link:../plugins-native/README.adoc[plugins-native] - GraalVM Native Image support (used by native bundles)
* link:../plugins-lombok/README.adoc[plugins-lombok] - Lombok support
* link:../plugins-misc/README.adoc[plugins-misc] - Full `ultima-nexus-jvm` bundle (Spring Boot + Native + Lombok)
